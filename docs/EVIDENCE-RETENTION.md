...
| --- | --- | --- | --- |
| `one-shot/VERIFICATION-REPORT.md`, graduation report/state, Linux Quality log | `cat-paw-air-hockey-64741220be29` / `0d1827…6b53` | VERIFIED | Current generation; retain and update only from real gates. |
| `one-shot/canonical-browser.json` | `cat-paw-air-hockey-95ed3f8aa868` / `816c04…1adf` | SUPERSEDED | Retain as the immediately previous Windows materialization browser record; it is not the Pages candidate. |
