...
func build_animations() -> void:
	...
	value_track(goal, "Rig:position", [[0.0, Vector2.ZERO], [0.14, Vector2(0, -3)], [0.36, Vector2(0, -5)], [0.54, Vector2(0, -3)], [0.72, Vector2.ZERO]])
	value_track(goal, "Rig:rotation", [[0.0, 0.0], [0.36, -0.08], [0.54, 0.07], [0.72, 0.0]])
	value_track(goal, "Rig:scale", [[0.0, Vector2.ONE], [0.14, Vector2(1.04, 0.97)], [0.36, Vector2(0.98, 1.05)], [0.72, Vector2.ONE]])
	value_track(goal, "Rig/Head:expression", [[0.0, 2.0], [0.14, 1.0]], true)
	value_track(goal, "Rig/FrontPawLeft:position", [[0.0, Vector2(-14, -22)], [0.14, Vector2(-19, -34)], [0.36, Vector2(-20, -43)], [0.72, Vector2(-14, -22)]])
	value_track(goal, "Rig/FrontPawRight:position", [[0.0, Vector2(14, -22)], [0.14, Vector2(18, -35)], [0.36, Vector2(21, -42)], [0.72, Vector2(14, -22)]])
	...
	value_track(conceded, "Rig:rotation", [[0.0, 0.0], [0.24, -0.12], [0.34, 0.13], [0.72, -0.03]])
	value_track(conceded, "Rig:scale", [[0.0, Vector2(1.04, 0.96)], [0.24, Vector2(0.96, 1.03)], [0.72, Vector2(1.0, 0.96)]])
	...
	value_track(win, "Rig:rotation", [[0.0, 0.0], [0.16, -0.06], [0.34, 0.03], [0.52, -0.10], [0.72, 0.10], [1.05, 0.0]])
	value_track(win, "Rig:scale", [[0.0, Vector2.ONE], [0.34, Vector2(0.98, 1.06)], [0.52, Vector2(1.04, 0.98)], [1.05, Vector2.ONE]])
	value_track(win, "Rig/Head:expression", [[0.0, 1.0]], true)
	value_track(win, "Rig/FrontPawLeft:position", [[0.0, Vector2(-14, -22)], [0.16, Vector2(-20, -36)], [0.34, Vector2(-22, -45)], [0.52, Vector2(-12, -36)], [0.72, Vector2(-22, -42)], [1.05, Vector2(-14, -22)]])
	value_track(win, "Rig/FrontPawRight:position", [[0.0, Vector2(14, -22)], [0.16, Vector2(20, -35)], [0.34, Vector2(22, -44)], [0.52, Vector2(12, -26)], [0.72, Vector2(22, -42)], [1.05, Vector2(14, -22)]])
