---
{"schema":"sfhs.one-shot-decision-log@1","status":"VERIFIED","facts":{"decisions":["D-001 portrait-first 540x1200 shared-phone rink","D-002 zero finger offset","D-003 first-to-five ready/countdown/rematch flow","D-004 fixed-step bounded physics","D-005 optional reduced effects","D-006 procedural audio","D-007 readable committed source is authoritative","D-008 canonical output is packer-produced only","D-012 four shared center controls","D-013 independent 1080x2400 Board","D-014 dynamic NineSlice couch goals","D-015 Godot-authored score-cat sheets","D-016 score-cat physical gate before SFHS extraction"]}}
---
# Decisions
