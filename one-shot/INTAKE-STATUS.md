...
The current pin is SFHS `5acd8fc9a24834d9416a6e615bb78b8012962e30`, Node 24, pnpm 11.9.0, Pixi 8.19.0. Canonical browser evidence is retained at `one-shot/canonical-browser.json`; the Godot-authored score cats remain presentation assets inside the same sole WebGL canvas. Samsung reported build `cat-paw-air-hockey-1e9558fbf0aa` failed score-cat readability, and build `cat-paw-air-hockey-235ab3123bc4` was rejected because its 120 x 120 cats were only 1.5x rather than the requested 2x. Exact-double build `cat-paw-air-hockey-ffaa71fb1d0d` is UNTESTED. No Cat Paw remote mutation is authorized.
