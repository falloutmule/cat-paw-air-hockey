...
The current pin is SFHS `5acd8fc9a24834d9416a6e615bb78b8012962e30`, Node 24, pnpm 11.9.0, Pixi 8.19.0. Canonical browser evidence is retained at `one-shot/canonical-browser.json`; the Godot-authored score cats remain presentation assets inside the same sole WebGL canvas. Physical Samsung evidence is historical REPORTED evidence, while build `cat-paw-air-hockey-1e9558fbf0aa` is UNTESTED. No Cat Paw remote mutation is authorized.
