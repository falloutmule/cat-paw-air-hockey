...
The current pin is SFHS `5acd8fc9a24834d9416a6e615bb78b8012962e30`, Node 24, pnpm 11.9.0, Pixi 8.19.0. Canonical browser evidence is retained at `one-shot/canonical-browser.json`; physical Samsung evidence is historical REPORTED evidence, while the current artifact is UNTESTED. GitHub Pages is authorized but remains PROPOSED until the canonical-branch deployment hash is recorded.
